...
!function(){"use strict";module.exports=require("./lib/index")}();
},{"./lib/index":7}],7:[function(require,module,exports){
(function (global,Buffer){
!function(e){"use strict";function t(e){return e instanceof Buffer}function i(e){return e instanceof ArrayBuffer}function n(e){return!(32>e||127===e||129===e||141===e||143===e||144===e||157===e||e>255)}var r=e.XP||require("expandjs"),s={Int8:{size:1,needsEndian:!1},UInt8:{size:1,needsEndian:!1},Int16:{size:2,needsEndian:!0},UInt16:{size:2,needsEndian:!0},Int32:{size:4,needsEndian:!0},UInt32:{size:4,needsEndian:!0},Float:{size:4,needsEndian:!0},Double:{size:8,needsEndian:!0}};module.exports=new r.Class("Parser",{initialize:function(e){r.assertArgument(t(e)||i(e),1,"Buffer or ArrayBuffer"),this._buffer=t(e)?e:new Buffer(e),this.addShorthandMethods_()},_buffer:{value:null,configurable:!1,enumerable:!1},_endian:{value:"LE",configurable:!1,enumerable:!1},_offset:{value:0,configurable:!1,enumerable:!1},endianess:function(e){return r.assertArgument(r.isString(e),1,"String"),e=r.lowerCase(e),("little"===e||"le"===e)&&(this._endian="LE"),("big"===e||"be"===e)&&(this._endian="BE"),this._endian},size:function(){return this._buffer.length},stringView:function(){return r.map(this._buffer,function(e){return String.fromCharCode(e)})},hexView:function(){var e="";return r.map(this._buffer,function(t){return e=16>t?"0":"",r.upperCase(e+t.toString(16))})},ansiView:function(){return r.map(this._buffer,function(e){return n(e)?String.fromCharCode(e):"."})},tell:function(){return this._offset},seek:function(e){return r.assertArgument(r.isNumber(e),1,"Number"),r.assertArgument(r.isWithin(e,0,this.size()),1,"Out of bound"),this._offset=e,this._offset},skip:function(e){return this.seek(this.tell()+e)},int8:function(e){return r.assertArgument(r.isVoid(e)||r.isPositive(e),1,"Positive number"),this._read({_read:"Int8",_length:e})},uint8:function(e){return r.assertArgument(r.isVoid(e)||r.isPositive(e),1,"Positive number"),this._read({_read:"UInt8",_length:e})},int16:function(e){return r.assertArgument(r.isVoid(e)||r.isPositive(e),1,"Positive number"),this._read({_read:"Int16",_length:e})},uint16:function(e){return r.assertArgument(r.isVoid(e)||r.isPositive(e),1,"Positive number"),this._read({_read:"UInt16",_length:e})},int32:function(e){return r.assertArgument(r.isVoid(e)||r.isPositive(e),1,"Positive number"),this._read({_read:"Int32",_length:e})},uint32:function(e){return r.assertArgument(r.isVoid(e)||r.isPositive(e),1,"Positive number"),this._read({_read:"UInt32",_length:e})},"float":function(e){return r.assertArgument(r.isVoid(e)||r.isPositive(e),1,"Positive number"),this._read({_read:"Float",_length:e})},"double":function(e){return r.assertArgument(r.isVoid(e)||r.isPositive(e),1,"Positive number"),this._read({_read:"Double",_length:e})},string:function(e){return r.assertArgument(r.isPositive(e),1,"Positive number"),this.skip(e),this._buffer.toString("utf8",this._offset-e,this._offset)},string0:function(){for(var e=this.tell(),t=e;0!==this["byte"]();)t+=1;return this._buffer.toString("utf8",e,t)},bit8:function(e){return r.assertArgument(r.isVoid(e)||r.isPositive(e),1,"Positive number"),this._mapBitField(this.uint8(e),8)},bit16:function(e){return r.assertArgument(r.isVoid(e)||r.isPositive(e),1,"Positive number"),this._mapBitField(this.uint16(e),16)},bit32:function(e){return r.assertArgument(r.isVoid(e)||r.isPositive(e),1,"Positive number"),this._mapBitField(this.uint32(e),32)},addShorthandMethods_:function(){var e=this;e["byte"]=e.int8,e.ubyte=e.uint8,e["short"]=e.int16,e.ushort=e.uint16,e["int"]=e.int32,e.uint=e.uint32,e["long"]=e["double"]},_read:{value:function(e){var t,i=[],n=e._read+(s[e._read].needsEndian?this._endian:""),r=e._length||1;for(t=0;r>t;t+=1)i.push(this._buffer["read"+n](this._offset)),this.skip(s[e._read].size);return 1===r?i[0]:i},configurable:!1,enumerable:!1,writable:!1},_mapBitField:function(e,t){var i,n=[];for(i=0;t>i;i+=1)n.push(0!==(e&1<<i));return n}})}("undefined"!=typeof window?window:global);
...
//# sourceMappingURL=dist/binary-buffer-parser.map.json